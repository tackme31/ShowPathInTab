...
{
    public class ShowPathInTabViewElementFactory : DelegatingViewElementFactory
    {
        public ShowPathInTabViewElementFactory(ViewElementFactory innerFactory) : base(innerFactory)
        {
        }
